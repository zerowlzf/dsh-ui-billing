...
export const zh = {
  ...
  'section.summary': '本会话费用与 DeepSeek 余额，按你自己维护的每条路由单价计算。',
  'form.unavailable': '此部署未提供计费配置，暂无可编辑的单价。',
  'form.saveFailed': '保存未被接受，请重试。',
...
export const en: Record<BillingKey, string> = {
  ...
  'section.summary': 'Session cost and the DeepSeek balance, priced by the per-route rates you maintain.',
  'form.unavailable': 'This deployment does not serve the billing configuration, so there are no rates to edit.',
  'form.saveFailed': 'The save was not accepted; try again.',
